  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
            ...
            data: LineChartData(
              ...
              xAxis: LineChartXAxis(
                label: LineChartXLabel(
                  texts: spotsList.first.map((spot) => LineChartLabelText(spot.x, outputFormat.format(DateTime(today.year, today.month, today.day - _dataNum + spot.x.toInt() + 1)))).toList(),
                  style: TextStyle(
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Text(
                            outputFormat.format(DateTime(today.year, today.month, today.day - _dataNum + spots.first!.x.toInt() + 1)),
                          ),
                        ),
                        const Divider(
                          color: Colors.grey,
        ...
        ElevatedButton(onPressed: () => setSpotsList(), child: const Text('Refresh'))
      ],
    );
  }
}
