//import 'package:fluent_page.dart';
...
class Person {
  ...
  @override
  String toString() => 'Person(username: $username, name: $name, imageUrl: $imageUrl)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is Person && other.username == username && other.name == name && other.imageUrl == imageUrl;
  }
